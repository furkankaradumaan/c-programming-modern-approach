...
void analyze_cards(int cards[NUM_CARDS][2], bool *flush,
                   bool *straight, bool *four, bool *three,
                   bool *royal, bool *ace_low, int *pairs);
void print_result(bool flush, bool straight, bool four,
                  bool three, bool royal, bool ace_low, int pairs);

int main() {
        int pairs;
        bool flush, straight,
             four, three, royal, ace_low;
        int cards[NUM_CARDS][2];

        for (;;) {
                read_cards(cards);
                analyze_cards(cards, &flush, &straight,
                              &four, &three, &royal, &ace_low,
                              &pairs);
                print_result(flush, straight, four,
                             three, royal, ace_low, pairs);
        }
}
